...
- Name: admin-prompts.spec.ts >> View a prompt version's details and activate an older one >> admin views v1 details and reactivates it, making it the active version again
- Location: e2e/admin-prompts.spec.ts:58:7
