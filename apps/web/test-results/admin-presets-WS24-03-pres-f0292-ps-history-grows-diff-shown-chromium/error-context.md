...
- Name: admin-presets.spec.ts >> WS24-03: presets admin — edit creates a new active version + diff >> admin edits a preset; version bumps, history grows, diff shown
- Location: e2e/admin-presets.spec.ts:22:7
