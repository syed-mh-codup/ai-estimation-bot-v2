      ...
      menuItems: [
        {
          ...
          enabled: true,
          lineItems: [
            { role: 'DEV', baseHours: 3.5, taxedHours: 3.5, provenance: 'CREW' },
            { role: 'DEV', baseHours: 2, taxedHours: 2, provenance: 'CREW' },
            { role: 'QA', baseHours: 2, taxedHours: 2.4, provenance: 'CREW' },
            { role: 'PM', baseHours: 1, taxedHours: 1.1, provenance: 'CREW' },
            { role: 'BA', baseHours: 1, taxedHours: 1.2, provenance: 'CREW' },
          ],
        },
      ],
    });
